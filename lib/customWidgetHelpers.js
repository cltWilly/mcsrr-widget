...
export const AVAILABLE_FEATURES = [
  ...
  { id: 'eloPlusMinus', label: 'ELO +/-', width: 60, height: 20, type: 'text', defaultColor: '#9CA3AF', supportsConditional: true, conditionalType: 'positive-negative' },
...
export const WIDGET_TEMPLATES = [
  ...
  // },
  {
    ...
    elements: [
      ...
      { id: 'eloPlusMinus', label: 'ELO +/-', x: 100, y: 14, width: 60, height: 20, type: 'text', color: '#9CA3AF', font: AVAILABLE_FONTS[0], scale: 1.2, useConditionalColor: true, conditionalType: 'positive-negative', supportsConditional: true, positiveColor: '#10B981', negativeColor: '#EF4444', neutralColor: '#9CA3AF' },
    ] 
  }
];
